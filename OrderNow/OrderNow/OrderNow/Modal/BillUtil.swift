    ...
    func dumpData(){
        ...
        ref.child("MonAn").observeSingleEvent(of: .value, with: { (snapshot) in
            ...
            for item in snapshot.children {
                ...
                let monanItem = MonAn(monID: String(snap.key), gia: gia!, hinh: hinh!, soLuong:  loai!, ten: ten!)
            ...
            for item in snapshot.children {
                ...
                refItem.observeSingleEvent(of: .value, with: { (snapshotItem) in
                    for inerItem in snapshotItem.children {
                        ...
                        let mon = MonAn(monID: snapdata.key, gia: gia!, hinh: hinh!, soLuong: soLuong!, ten: ten!)
